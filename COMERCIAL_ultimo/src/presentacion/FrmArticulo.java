...
public class FrmArticulo extends javax.swing.JInternalFrame {
    ...
    private void cargarCampos() {
        String campos[] = new clsArticulo().obtenerCamposFiltro();
    ...
    private void cargartabla() {
        try {
            this.resultado = new clsArticulo().listar();
        } catch (Exception e) {
    ...
    private void listar() {
        try {
            String alineacion[] = {"C", "I","D","I","I","I"};
            int anchoColumnas[] = {140,200,120,220,150,150};
    ...
    private void btnAgregarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnAgregarActionPerformed
        FrmArticuloMantenimiento obj = new FrmArticuloMantenimiento(null, true);
